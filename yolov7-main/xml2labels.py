...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_dir_path', type=str, default='D:\CodeFiles\data\\vehicle_data\\vehicle\images\\', help='img所在文件目录路径')

    parser.add_argument('--xml_txt_path', type=str, default='/home/data/vehicle_data/all_det_xmls.txt',
                        help='xml所在文件目录路径')

    parser.add_argument('--save_txt_dir_path', type=str, default='D:\CodeFiles\data\\vehicle_data\\vehicle\labels\\',
                        help='需要保存txt文件目录路径')
