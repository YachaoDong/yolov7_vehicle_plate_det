...
//     void CRNNRecognizerInit(const std::string &model_dir, const bool &use_gpu,
//                           const int &gpu_id, const int &gpu_mem,
//                           const int &cpu_math_library_num_threads,
//                           const bool &use_mkldnn, const string &label_path,
//                           const bool &use_tensorrt,
...
//     void CRNNRecognizerUnInit(){
//       std::cout << " USE ~CRNNRecognizer" << std::endl;
//       if (this->predictor_.get() != nullptr){
//           std::cout << " USE this->predictor_.get() != nullptr" << std::endl;
//           this->predictor_.reset();
//           std::cout << " USE this->predictor_.reset()" << std::endl;
//       }
...
//           std::cout << " USE this->predictor_.reset()" << std::endl;
//       }
//       //std::cout << " this->predictor_..use_count()" << this->predictor_.use_count()<< std::endl;
