...
DEFINE_string(image_dir, "/home/data/781/粤AF61128_green.jpg", "Dir of input image.");
DEFINE_string(
    type, "ocr",
...
// recognition related
DEFINE_string(rec_model_dir, "/project/train/src_repo/paddle_cpp_infer/ch_PP-OCRv3_rec_infer", "Path of rec inference model.");
DEFINE_int32(rec_batch_num, 1, "rec_batch_num.");
DEFINE_string(rec_char_dict_path, "/project/train/src_repo/PaddleOCR/ppocr/utils/plate_dict.txt",
              "Path of dictionary.");
DEFINE_int32(rec_img_h, 32, "rec image height");
DEFINE_int32(rec_img_w, 100, "rec image width");

// ocr forward related
DEFINE_bool(det, false, "Whether use det in forward.");
